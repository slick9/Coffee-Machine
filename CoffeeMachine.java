...
public class CoffeeMachine {
    ...
    public static void main(String[] args) {
        ...
        while (machine.menuState!= MenuState.OFF){
            machine.getInput();
    ...
    public void  getInput() {
        switch (menuState){
            case MAIN_MENU:
                System.out.println(MenuState.MAIN_MENU.menuOutput);
                setState(scanner.next());
                break;
            case BUY:
                System.out.println(MenuState.BUY.menuOutput);
                buy(scanner.next());
                break;
            case TAKE:
                System.out.println(MenuState.TAKE.menuOutput);
                take();
                break;
            case FILLING:
                System.out.println(MenuState.FILLING.menuOutput);
                fill();
                break;
            case REMAINING:
                ingredients();
    ...
    public void setState(String input){
        switch (input){
            case "buy":
                ...
                break;
            case  "fill":
                menuState = MenuState.FILLING;
                break;
            case  "take":
                menuState = MenuState.TAKE;
                break;
            case "remaining":
                menuState = MenuState.REMAINING;
                break;
            case  "exit":
